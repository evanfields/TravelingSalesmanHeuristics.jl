...
function compareHeuristics(n = 20)
	...
	repnn_no2opt = nearest_neighbor(dm, repetitive = true, do2opt = false)
	println("Multi start nearest neighbor without 2-opt has cost $(repnn_no2opt[2])")
	repnn_2opt = nearest_neighbor(dm, repetitive = true, do2opt = true)
	...
	multici_no2opt = cheapest_insertion(dm, repetitive = true, do2opt = false)
	println("Multi start cheapest insert without 2-opt has cost $(multici_no2opt[2])")
	multici_2opt = cheapest_insertion(dm, repetitive = true, do2opt = true)
